...
def generate_test_file(
    name: str, extention: str, size_gb: float, dir_path: Path
) -> None:
    """
...
def create_and_upload_json_data_file(
    name, data, client, bucket_name, file_path=None, prefix=""
):
    if not file_path:
